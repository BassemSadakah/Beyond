...
if (Number(answer) > Number(ans_num) || Number(answer) < 0) {
  ...
  console.log('5')
  var query = ("INSERT INTO questions (user_id,question,question_img,answer_img,ans_num,ans_a,ans_b,ans_c,ans_d,ans_e,ans_f,ans_g,ans_h,answer,question_type,isapproved) VALUES (" + user_data.id + "," + ((!question) ? "NULL" : ("'" + question + "'")) + "," + ((!question_img) ? "NULL" : ("'" + question_img + "'")) + "," + ((!answer_img) ? "NULL" : ("'" + answer_img + "'")) + ",'" + ans_num + "'," + ((!choices[0]) ? "NULL" : ("'" + choices[0] + "'")) + "," + ((!choices[1]) ? "NULL" : ("'" + choices[1] + "'")) + "," + ((!choices[2]) ? "NULL" : ("'" + choices[2] + "'")) + "," + ((!choices[3]) ? "NULL" : ("'" + choices[3] + "'")) + "," + ((!choices[4]) ? "NULL" : ("'" + choices[4] + "'")) + "," + ((!choices[5]) ? "NULL" : ("'" + choices[5] + "'")) + "," + ((!choices[6]) ? "NULL" : ("'" + choices[6] + "'")) + "," + ((!choices[7]) ? "NULL" : ("'" + choices[7] + "'")) + "," + ((!answer) ? "NULL" : ("'" + answer + "'")) + ",'" + question_type + "',1)");
